...
const userData: UserData = {
  ...
  contacts: {
    ...
    github: 'https://github.com/boostcampwm-2024',
      ...
      <div className="flex items-center items w-1/3 h-full">
        <div className="flex flex-col h-3/5 justify-between">
          <div className="flex flex-row gap-5 items-center">
            <span className="font-bold text-text-strong text-4xl">{userData.camperId}</span>
            <div className="flex justify-center items-center bg-surface-brand-default text-text-strong text-display-bold24 w-24 rounded">
              {userData.field}
            </div>
            <EditIcon size={36} />
          </div>
